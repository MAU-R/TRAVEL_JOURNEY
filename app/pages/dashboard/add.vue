...
import { CENTER_USA } from "~/utils/constants";
import { InsertLocation } from "~/utils/db/schema";
...
/*
dirty = when some data has been filled
when dirty well confirm with the user if he actually wants to loose its changes
...
onBeforeRouteLeave(() => {
  ...
  // this returns in case its not dirty
  return true;
});
</script>
